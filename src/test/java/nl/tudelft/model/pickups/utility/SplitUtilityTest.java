...
public class SplitUtilityTest {
    ...
    public void testConstructor() {
        ...
        assertEquals(mockedResources.getPickupUtilitySplit(), utility.getImage());
    ...
    public void testActivate1() {
        ...
        verify(mockedLevel, times(1)).splitAllBubbles(bubbles, false);
    }
}
