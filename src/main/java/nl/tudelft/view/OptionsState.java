...
public class OptionsState extends BasicGameState {
    ...
    public boolean isLoggerSetEnabled() {
        return loggerSetEnabled;
    }

    public void setLoggerSetEnabled(boolean state) {
     ...
     */
    public void setController(OptionsStateController controller) {
     ...
     */
    public LoggerSetScreen getLoggerSetScreen() {
        return loggerSetScreen;
    }
     ...
     */
    public void setAreas(MouseOverArea area) {
        soundOnOff = area;
        backButton = area;
        loggerButton = area;
        keyButton = area;
