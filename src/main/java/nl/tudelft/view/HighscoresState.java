...
import nl.tudelft.controller.HighscoresStateController;
...
public class HighscoresState extends BasicGameState {
     ...
     */
    public void setController(HighscoresStateController controller) {
     ...
     */
    public void setBackButton(MouseOverArea area) {
