...
public class KeyBindStateController {
     ...
     *                  image can't be created
     */
    protected MouseOverArea createButtonArea(float overCoordX, float overCoordY,
            GameContainer container, String text, TrueTypeFont typeFont,
            ResourcesWrapper res) throws SlickException {
     ...
     */
    protected void setKey(int counter, InputKey key) {
        switch (counter) {
     ...
     *                  the key
     */
    protected String getKey(int counter) {
        switch (counter) {
