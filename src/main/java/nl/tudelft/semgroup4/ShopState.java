...
public class ShopState extends BasicGameState {
    ...
    public void render(GameContainer container, StateBasedGame game,
        ...
        graphics.drawImage(resources.getShopBackGround(), 0, 0, container
                .getWidth(), container.getHeight(), 0, 0, resources
                .getShopBackGround().getWidth(), resources.getShopBackGround()
                .getHeight());
