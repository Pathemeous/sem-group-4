...
public final class Resources {
    ...
    /**
     * Method that loops over all the files in the img folder, and makes an 
     * constructs a Slick image from each file, storing the image in a hashmap,
     * with the filepath as key. 
    ...
    /**
     * Method that loops over all the files in the sounds folder, and makes an 
     * constructs a Slick sound from each file, storing the sound in a hashmap,
     * with the filepath as key. 
     * @throws IOException : java exception.
     */
    ...
    /**
     * Method that loops over all the files in the music folder, and makes an 
     * constructs a Slick music from each file, storing the music in a hashmap,
     * with the filepath as key. 
     * @throws IOException : java exception.
     */
    ...
    /**
     * Method that loops over all the files in the animation folder, and makes an 
     * constructs a Slick animation from the images in each inner folder, 
     * storing the animation in a hashmap, with the filepath as key. 
     * @throws IOException : java exception.
     */
    ...
    /**
     * Loops over each item of the hashmap. Each item consists of a hashmap, which contains
     * images belonging to one animation. The key of the outer hashmap is used as key to
     * store the animtion.
     */
