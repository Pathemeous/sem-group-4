...
public class Bubble2 extends Bubble {
     ...
     */
    public Bubble2(float locX, float locY) {
        this(locX, locY, true);
    }
     ...
     *      is to the right.
     */
    public Bubble2(float locX, float locY, boolean goRight) {
        super(Resources.bubbleImage2, locX, locY, goRight);
        
        setMaxVerticalSpeed(6.0f);
        
        getNext().add(new Bubble1(locX, locY, true));
        getNext().add(new Bubble1(locX, locY, false));
    }
