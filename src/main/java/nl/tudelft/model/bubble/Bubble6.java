...
public class Bubble6 extends Bubble {
    ...
    public Bubble6(ResourcesWrapper resources, float locX, float locY, boolean goRight) {
        super(resources.getBubbleImage6(), locX, locY, goRight);

        setMaxVerticalSpeed(10.0f);

        getNext().add(new Bubble5(new ResourcesWrapper(), locX, locY, true));
        getNext().add(new Bubble5(new ResourcesWrapper(), locX, locY, false));
    }
