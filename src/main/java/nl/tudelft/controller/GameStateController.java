...
public class GameStateController {
    ...
    /**
     * Creates a game state controller, which controls the logic for the GameState.
     * 
     * @param game
     *            : the current game this GameState is based on.
     */
    ...
    /**
     * Checks if the game is paused with the pause screen opened (which would toggle the
     * pausescreen to close) or if the game is running (which would toggle the pausescreen to open.
     * 
     * @param pauseScreenOpened
     *            : boolean that indicates if the pause screen is open.
     * @param input
     *            : slick input.
    ...
    public boolean togglePauseMenu(boolean pauseScreenOpened, Input input) {
        ...
        if (currentGame.isPaused() && pauseScreenOpened
            ...
            AbstractGame.LOGGER.log(LogSeverity.DEBUG, "Game",
                    "Player " + (currentGame.isPaused() ? "resumed" : "paused") + " the game");
    ...
    /**
     * Updates the current game. If the game is not paused, the game itself is updated. If the game
     * is paused, it might mean that the countdown is still running, so the countdown is updated.
     * 
     * @param delta
     *            : does nothing at all.
     ...
     * 
     * @param pauseScreenOpened
     *            : boolean to indicate if the pause screen is opened.
     * @param pauseScreen
     *            : view for the pausescreen.
     * @param graphics
     *            : Slick2D graphics.
     * @param container
     *            : Slick2D GameContainer.
     * @param input
     *            : Slick2D input.
     * @param game
    ...
    public void showPauseScreen(boolean pauseScreenOpened, PauseScreen pauseScreen,
            Graphics graphics, GameContainer container, Input input, StateBasedGame game,
            GameState gamestate) {
